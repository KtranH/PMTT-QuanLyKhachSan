                  ...
                  <div class="card mb-3" style="border-radius:20px">
                    ...
                    <div class="card-body">
                      ...
                      <form class="row g-3 needs-validation" novalidate method="POST" action="{{ route('signup') }}">
                        ...
                        <div class="col-12">
                          <label for="yourUsername" class="form-label">Nhập số căn cước công dân</label>
                          <div class="input-group has-validation">
                            <input type="number" name="cccd" class="form-control" id="yourUsername" required minlength="10">
                            <div class="invalid-feedback">Vui lòng nhập đúng số căn cước công dân!.</div>
                            @if(Session::has('errorSignUp'))
                              <div class="form-label" style="width:100%; color: red">{{ Session::get('errorSignUp') }}</div>
                            @endif
                          </div>
