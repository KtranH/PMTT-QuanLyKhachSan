                    ...
                    <div class="card-body pt-3">
                        ...
                        <ul class="nav nav-tabs nav-tabs-bordered">
                            ...
                            <table class="table table-borderless datatable">
                              ...
                              <form action="{{ route("ct_reserve_kh") }}" method="post" style="marign-bottom:20px">
                                @csrf
                            ...
                            font-style: normal;">Kết quả tra cứu</h5>
                             <table class="table table-borderless datatable">
                                ...
                                <tr>
                                    ...
                                    <td><a href="#" class="text-primary"><?php echo $item->SDT ?></a></td>
                                    <td><?php echo $item->CCCD ?></td>
                                    <td><a href="{{ route("addkh",["makh"=>$item->MAKH]) }}" type="button" class="btn btn-info" style="border-radius:20%;margin-right:20px;color:white;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;background-color:#74C0FC"><i class="fi fi-rr-file-edit"></i></a></td>
                                </tr>              
                                @endforeach
                            </tbody>
                          </table>
                          ...
                          font-style: normal;">Thêm mới khách hàng</h5>
                            <form action="{{ route("addkh2") }}" method="post">
                              @csrf
                                <div style="width:100%">
